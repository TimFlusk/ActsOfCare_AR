...
{
    public class CoreFaceLandmarkerRunner : VisionTaskApiRunner<FaceLandmarker>
    {
        ...
        protected override IEnumerator Run()
        {
            ...
            // NOTE: we can share the GL context of the render thread with (for now, only on Android)
            ...
            while (true)
            {
                ...
                {
                    trackingEventHandler.OnPoseUpdateEvent.Invoke(faceLandmarkerResult);
                }
