...
namespace TrackerPro.Unity.Sample.Holistic
{
  public class HolisticTrackingSolution : LegacySolutionRunner<HolisticTrackingGraph>
  {
    ...
    protected override IEnumerator Run()
    {
      ...
      // TODO: When using GpuBuffer, TrackerPro assumes that the input format is BGRA, so the following code must be fixed.
