  ...
  public readonly struct HandLandmarkerResult:ITrackingResult
  {
        ...
        List<NormalizedLandmarks> handLandmarks, List<Landmarks> handWorldLandmarks)
    {
      ...
      this.handWorldLandmarks = handWorldLandmarks;
        ...
        public bool HasData => handLandmarks != null && handLandmarks.Count > 0;
