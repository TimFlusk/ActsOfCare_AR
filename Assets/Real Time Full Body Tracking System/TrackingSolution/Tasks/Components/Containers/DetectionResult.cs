...
namespace TrackerPro.Tasks.Components.Containers
{
  /// <summary>
  ...
  public readonly struct Detection
  {
    ...
    public static Detection CreateFrom(TrackerPro.Detection proto)
    {
    ...
    public static void Copy(TrackerPro.Detection proto, ref Detection destination)
    {
...
#pragma warning restore IDE0004
  ...
  public readonly struct DetectionResult
  {
    ...
    public static DetectionResult CreateFrom(List<TrackerPro.Detection> detectionsProto)
    {
    ...
    public static void Copy(List<TrackerPro.Detection> source, ref DetectionResult destination)
    {
