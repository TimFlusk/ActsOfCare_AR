...
namespace TrackerPro
{
  public sealed class ClassifierOptions
  {
    ...
    internal TrackerPro.Tasks.Components.Processors.Proto.ClassifierOptions ToProto()
    {
      var proto = new TrackerPro.Tasks.Components.Processors.Proto.ClassifierOptions()
      {
